		...
		switch(formatStr[i]){
			...
			case "l":
				...
				for(var n=0; n<days.length; n++){
					if(!d.indexOf(days[n].toLowerCase())){
						day = days[n];
						break;
					}
				}
			...
			case "D":
				...
				for(var n=0; n<days.length; n++){
					if(days[n].length>6 && !d.indexOf(days[n].toLowerCase().substr(0,6))){
						abrlen = 6; break;
					}
					if(!d.indexOf(days[n].toLowerCase().substr(0,5))){
						abrlen = 5; break;
					}
					if(!d.indexOf(days[n].toLowerCase().substr(0,4))){
						abrlen = 4; break;
					}
					if(!d.indexOf(days[n].toLowerCase().substr(0,3))){
						abrlen = 3; break;
					}
				}
			...
			case "F":
				...
				for(var n=0; n<months.length; n++){
					if(!m.indexOf(months[n].toLowerCase())){
						mm = months[n];
						break;
					}
				}
			...
			case "M":
				var m = dateStr.toLowerCase(), mm=false;
				for(var n=0; n<months.length; n++){
					if(!m.indexOf(months[n].toLowerCase().substr(0,3))){
						mm = months[n];
						break;
					}
				}
